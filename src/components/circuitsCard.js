...
export function circuitCard(data) {
    return`
    <div class="circuit-card card" data-type="circuits" data-id="${data.ciruitId}" data-url="${data.url}" data-lat="${data.Location.lat}" data-long="${data.Location.long}" data-locality="${data.Location.locality}">
